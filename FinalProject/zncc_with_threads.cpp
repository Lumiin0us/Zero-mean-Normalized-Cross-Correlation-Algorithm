...
void calculate_disparity_map_left(const std::vector<unsigned char> &leftImg, const std::vector<unsigned char> &rightImg, std::vector<unsigned char> &disparityImg, int width, int height, int winSize, int maxDisp)
{
    ...
    std::cout << "Thread Disparity-Left Running! " << std::endl;
...
void calculate_disparity_map_right(const std::vector<unsigned char> &leftImg, const std::vector<unsigned char> &rightImg, std::vector<unsigned char> &disparityImg, int width, int height, int winSize, int maxDisp)
{
    ...
    std::cout << "Thread Disparity-Right Running! " << std::endl;
...
int main()
{
    ...
    // separate threads for left and right disparity maps
    std::thread first_thread(calculate_disparity_map_left, std::cref(leftImg), std::cref(rightImg), std::ref(disparityImgLeft), width, height, patch_size, max_disparity);
    std::thread second_thread(calculate_disparity_map_right, std::cref(leftImg), std::cref(rightImg), std::ref(disparityImgRight), width, height, patch_size, max_disparity);
